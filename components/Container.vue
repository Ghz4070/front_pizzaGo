  ...
  <div>
    ...
    <main>
      <section class="welcome">
        ...
        <p class="home_resume">
          La qualité étant au centre de nos préoccupations, chez PizzaGo nous
          faisons
          <br />des pizzas pour tout le monde, mais pas comme tout le monde !
        </p>
        <div class="content_img">
          <img
            elevation="5"
            class="separate_img"
            src="https://fivepizzaoriginal.com/pub/media/wysiwyg/Pizza-originale.jpg"
          />
        </div>
            ...
            <v-card class="mx-auto" max-width="400" min-height="400">
              ...
              <v-card-text class="text--primary">
                <div>
                  ...
                  nous faisons des pizzas pour tout le monde mais pas comme tout
                  le monde !
                </div>
              </v-card-text>
            </v-card>
            ...
            <v-card class="mx-auto" max-width="400" min-height="400">
              ...
              <v-card-text class="text--primary">
                <div>
                  ...
                  fabrication et livrons nos magasins plusieurs fois par semaine
                  afin de garantir un produit de qualité optimale. Notre pâte
                  est ainsi garantie fraîche et jamais congelée !
                </div>
              </v-card-text>
            </v-card>
          </v-col>
            ...
            <v-card class="mx-auto" max-width="400" min-height="400">
              ...
              <v-card-text class="text--primary">
                <div>
                  ...
                  la commande. Nos cuisines ouvertes permettent à nos clients de
                  voir 100% du processus de fabrication de nos pizzas, afin de
        ...
        <v-row>
          ...
          <v-col cols="12" sm="12" md="4">
            <img
              ...
              src="https://www.servicesmobiles.fr/wp-content/uploads/2018/04/app-store-download_IOS-APPSTORE.jpg"
            />
          </v-col>
        </v-row>
      </section>
